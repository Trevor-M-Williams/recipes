...
function Nav({ openModalWithContent }) {
  ...
  const openSearch = () => {
    openModalWithContent(
      <SearchResults closeSearch={() => openModalWithContent(null)} />
    );
  };
  ...
  return (
    <nav className="sticky top-0 bg-white flex justify-between items-center py-3 mb-2 sm:py-4 sm:mb-4">
      <div className="flex items-center">
        <Link href="/" className="h-6">
          <svg
            ...
            strokeWidth="2"
          >
            <path d="M19 9L19 17C19 18.8856 19 19.8284 18.4142 20.4142C17.8284 21 16.8856 21 15 21L14 21L10 21L9 21C7.11438 21 6.17157 21 5.58579 20.4142C5 19.8284 5 18.8856 5 17L5 9"></path>
      ...
      <div className="flex items-center gap-2 sm:gap-1">
        ...
        >
          <svg viewBox="0 0 24 24" height="80%" fill="none">
            <path
